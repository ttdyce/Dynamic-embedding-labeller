...
Intercept<int> intercepts[] = {Intercept<int>(1, 3), Intercept<int>(0, 2), Intercept<int>(0, 2), Intercept<int>(1, 2), Intercept<int>(0, 4), Intercept<int>(0, 4), Intercept<int>(1, 5) };
